...
IF(NOT EXISTS "/home/jack/hunter/src/build/install_manifest.txt")
  MESSAGE(FATAL_ERROR "Cannot find install manifest:\"/home/jack/hunter/src/build/install_manifest.txt\"")
ENDIF(NOT EXISTS "/home/jack/hunter/src/build/install_manifest.txt")
...
FILE(READ "/home/jack/hunter/src/build/install_manifest.txt" files)
...
ENDFOREACH(file)
EXECUTE_PROCESS(
  COMMAND "/usr/bin/cmake" -E remove "/home/jack/hunter/src/build/install_manifest.txt"
  RESULT_VARIABLE rm_resval
  OUTPUT_VARIABLE rm_out
  ERROR_QUIET
  )
