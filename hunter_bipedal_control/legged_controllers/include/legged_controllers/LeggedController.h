...
private:
  ...
  benchmark::RepeatedTimer loopTimer_,cpTimer_;
  ...
  std::atomic<scalar_t> kp_pri{ 0 };
  std::atomic<scalar_t> kd_pri{ 0 };
  std::atomic<scalar_t> kp_pri_walk{ 0 };
  std::atomic<scalar_t> kd_pri_walk{ 0 };
